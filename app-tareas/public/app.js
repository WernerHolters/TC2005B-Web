...
const el = {
  app: null,
  usersSel: null, usersForm: null, usersInput: null,
  taskForm: null, taskTitle: null, taskDesc: null, taskAssignee: null,
  taskStatus: null, searchInput: null, statusFilter: null, tableBody: null,
  pager: null
};

let state = { page: 1, pageSize: 10, q: '', status: '' };
  ...
  el.app.innerHTML = `
    ...
    <section>
      ...
      <table border="1" cellspacing="0" cellpadding="6" style="margin-top:8px; width:100%;">
        <thead><tr>
          <th>ID</th><th>Título</th><th>Descripción</th><th>Estado</th><th>Asignado a</th><th>Acciones</th>
        </tr></thead>
